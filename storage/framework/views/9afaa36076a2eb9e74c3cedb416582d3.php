<head>
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/css/bootstrap.rtl.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/styles/pages/main.css')); ?>">

    <title><?php echo $__env->yieldContent('title' ,'home'); ?></title>
</head>
<?php echo $__env->yieldContent('content'); ?>
<?php /**PATH D:\My Courses\Back End\Eraa Soft Course\Sessions codes\New folder (15)\first_project\resources\views/layout/front/header.blade.php ENDPATH**/ ?>