    ...
    <div class="page-wrapper">
            ...
            <div class="container pb-5">
                <div class="row gap-2">
                    <div class="col-sm order-sm-2">
                        <img src="<?php echo e(asset('assets')); ?>/images/banner.jpg" class="img-fluid banner-img banner-img"
        ...
        <div class="container">
            ...
            <div class="d-flex flex-wrap gap-4 justify-content-center">
                <div class="card p-2" style="width: 18rem;">
                    <img src="<?php echo e(asset('assets')); ?>/images/major.jpg"
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        ...
                        <a href="<?php echo e(route('Doctors_Page')); ?>" class="btn btn-outline-primary card-button">Browse
                            Doctors</a>
                    </div>
                </div>
            ...
            <section class="splide home__slider__doctors mb-5">
                <div class="splide__track ">
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                <img src="<?php echo e(asset('assets')); ?>/images/major.jpg" class="card-img-top rounded-circle card-image-circle"
                                    alt="major">
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center">Doctor Name</h4>
                                    <h6 class="card-title fw-bold text-center">Major</h6>
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center">Doctor Name</h4>
                                    <h6 class="card-title fw-bold text-center">Major</h6>
                                    <a href="<?php echo e(route('Doctors_Page')); ?>"
        ...
        <div class="banner container d-block d-lg-grid d-md-block d-sm-block">
            ...
            <div class="bottom--right bg-blue text-white">
                <img src="<?php echo e(asset('assets')); ?>/images/banner.jpg" class="img-fluid banner-img">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layout.front.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Courses\Back End\Eraa Soft Course\Sessions codes\New folder (15)\first_project\resources\views/front/home.blade.php ENDPATH**/ ?>